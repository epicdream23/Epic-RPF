...
namespace CodeWalker.Rendering
{
    public class Renderer
    {
        ...
        public bool rendermloshells = true; //Epic RPF: render the MLO's own shell/exterior archetype (off in the void gallery)
        ...
        public void RenderWorld(Dictionary<MetaHash, YmapFile> renderworldVisibleYmapDict, IEnumerable<Entity> spaceEnts)
        {
            ...
            for (int i = 0; i < ents.Count; i++)
            {
                ...
                if (ent.IsMlo)
                {
                    ...
                    {
                        VisibleMlos.Add(ent);
                        if (rendermloshells) renderworldentities.Add(ent);//the MLO's own shell/exterior (collisions rendering needs this too)

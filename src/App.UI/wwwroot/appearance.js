...
window.Appearance = (function () {
  ...
  const DEFAULTS = {
    ...
    outlineColor: '#4fd1c5',
    outlineWidth: 1,        // px
    terminal: false,        // show the PowerShell terminal button (rpfcli / admin key)
    autoInject: false,      // auto-inject decryption for locked archives the game loads
    injectProcs: 'Majestic Launcher',   // extra launcher process name(s) to also inject into
  };
